...
function altitude_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'altitude-google-fonts', '//fonts.googleapis.com/css?family=Playfair+Display:400|Roboto:300,400,500|Roboto+Condensed:300,400,700', array(), CHILD_THEME_VERSION );
...
function remove_aboutpage_title() {
	if (is_page('about') || is_page('garden-services') || is_page('indoor-styling') || is_page('our-work') || is_page('photo-gallery') || is_page('mood-board-gallery')) {
...
function sp_footer_creds_filter( $creds ) {
	$creds = '<p><a href="https://www.instagram.com/horaceandbaynes/"><i class="fa fa-instagram fa-3x footer-padding"></i></a></p>
	<p>[footer_copyright] HORACE & BAYNES &middot; WEBSITE BY <a href="http://www.carolinemarie.co.uk">Caroline Marie Web Design</a> </p>';
	return $creds;
}
